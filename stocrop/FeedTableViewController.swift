...
//  Instagram
//
//  Created by salman siraj on 1/23/19.
...
class FeedTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        query?.findObjectsInBackground(block: { (objects, error) in
            ...
            if let users = objects {
                ...
                for object in users {
                    ...
                    if let user = object as? PFUser {
                        ...
                        self.users[user.objectId!] = user.username! // Get username
            ...
            let getFollowedUsersQuery = PFQuery(className: "Following") // Get information of followers
                            ...
                            query.findObjectsInBackground(block: { (objects, error) in
                                ...
                                if let posts = objects {
                                    ...
                                    for post in posts {
                                        ...
                                        let userArray = (self.users[post["userid"] as! String])!.components(separatedBy: "@")
